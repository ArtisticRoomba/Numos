...
public sealed record SimulationConfigurationReport(
    ...
    float BulkFlowDamping,
    float LowPressureDeltaThresholdPa,
    float MinimumPressureTransferPa,
    float VacuumThresholdPa,
    int SleepThreshold,
    float SleepEpsilonPa,
    float VoxelSnapPressureRelativeEpsilon,
    bool VoxelSnappingEnabled,
    float VoxelSnapTemperatureEpsilonK,
    float VoxelSnapMoleFractionEpsilon,
