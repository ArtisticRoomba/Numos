...
internal sealed class ConfigurationPatch
{
    ...
    public float? VoxelSnapPressureRelativeEpsilon { get; init; }
    public bool? VoxelSnappingEnabled { get; init; }
    public float? VoxelSnapTemperatureEpsilonK { get; init; }
    public float? VoxelSnapMoleFractionEpsilon { get; init; }
    ...
    internal void ApplyTo(AtmosConfig config)
    {
        ...
        if (VoxelSnapPressureRelativeEpsilon.HasValue)
            config.VoxelSnapPressureRelativeEpsilon = VoxelSnapPressureRelativeEpsilon.Value;
        if (VoxelSnappingEnabled.HasValue)
            config.VoxelSnappingEnabled = VoxelSnappingEnabled.Value;
        if (VoxelSnapTemperatureEpsilonK.HasValue)
            config.VoxelSnapTemperatureEpsilon = VoxelSnapTemperatureEpsilonK.Value;
        if (VoxelSnapMoleFractionEpsilon.HasValue)
            config.VoxelSnapMoleFractionEpsilon = VoxelSnapMoleFractionEpsilon.Value;
